...
const DEFAULT_API_VERSION = config.DEFAULT_API_VERSION;
const DEFAULT_MAX_STEPS = config.DEFAULT_MAX_STEPS;
const DEFAULT_WIT_URL = config.DEFAULT_WIT_URL;
...
function Wit(opts) {
  ...
  const _config = this.config = Object.freeze(validate(opts));
